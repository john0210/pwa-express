...
const sequelize = new Sequelize(
  ...
  process.env.DB_MYSQL_PASSWORD, // 디비 접속 비밀번호
  {
    host: process.env.DB_MYSQL_HOST, // 사용 디비 호스트
    port: parseInt(process.env.DB_MYSQL_PORT), // 사용 디비 포트
    dialect: process.env.DB_MYSQL_DIALECT, // 사용 디비 드라이버
    ...
    pool: { // 커넥션풀 설정
      ...
      idle: parseInt(process.env.DB_MYSQL_IDLE_LIMIT) // 유휴 커넷션 유지 시간(ms)
    }
  } 
);
